...
!     WHEN COMPUTING PRECONDITIONER, USE FASTER HESSIAN VERSION (totzsps_hess) INSTEAD.
      ...
      fnorm1 = one/SUM(rzl_array(ns,n0,m1,:)**2)    !Norm for preconditioned R,Z forces: scale to m=1,n=0 r,z
...
!
!$omp parallel
!$omp+ private(k,l,m,mparity,mj,j1,n,ni,i,j1l,nsl)
!$omp+ private(work1,cosmux,sinmux)
      ALLOCATE (work1(ns,12), stat=i)
...
!           j1l=j1 + (k-1) * ns + (i-1) * nsz             
            j1l=j1 + l + (i-1) * nsz             
            nsl = j1l - j1 + ns
           
            r11(j1l:nsl,mparity)  = r11(j1l:nsl,mparity)  
     1                            + work1(j1:ns,1)*cosmu(i,m)
            ru1(j1l:nsl,mparity)  = ru1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,1)*sinmum(i,m)
            rcn1(j1l:nsl,mparity) = rcn1(j1l:nsl,mparity) 
     1                            + work1(j1:ns,1)*cosmux
            z11(j1l:nsl,mparity)  = z11(j1l:nsl,mparity)  
     1                            + work1(j1:ns,6)*sinmu(i,m)

            zu1(j1l:nsl,mparity)  = zu1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,6)*cosmum(i,m)
            zcn1(j1l:nsl,mparity) = zcn1(j1l:nsl,mparity) 
     1                            + work1(j1:ns,6)*sinmux
             
            lu1(j1l:nsl,mparity)  = lu1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,10)*cosmum(i,m)

            IF (.not.lthreed) CYCLE

            r11(j1l:nsl,mparity)  = r11(j1l:nsl,mparity)  
     1                            + work1(j1:ns,2)*sinmu(i,m)
            ru1(j1l:nsl,mparity)  = ru1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,2)*cosmum(i,m)
            rcn1(j1l:nsl,mparity) = rcn1(j1l:nsl,mparity) 
     1                            + work1(j1:ns,2)*sinmux
            rv1(j1l:nsl,mparity)  = rv1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,3)*cosmu(i,m) 
     1                            + work1(j1:ns,4)*sinmu(i,m)
            z11(j1l:nsl,mparity)  = z11(j1l:nsl,mparity)  
     1                            + work1(j1:ns,5)*cosmu(i,m)

            zu1(j1l:nsl,mparity)  = zu1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,5)*sinmum(i,m)
            zcn1(j1l:nsl,mparity) = zcn1(j1l:nsl,mparity) 
     1                            + work1(j1:ns,5)*cosmux
            zv1(j1l:nsl,mparity)  = zv1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,7)*cosmu(i,m) 
     1                            + work1(j1:ns,8)*sinmu(i,m)

            lu1(j1l:nsl,mparity)  = lu1(j1l:nsl,mparity)  
     1                            + work1(j1:ns,9)*sinmum(i,m)
            lv1(j1l:nsl,mparity)  = lv1(j1l:nsl,mparity)  
     1                            - (work1(j1:ns,11)*cosmu(i,m) 
     1                            +  work1(j1:ns,12)*sinmu(i,m))
         END DO                 ! i loop

        END DO                  ! m loop
      END DO                    ! k loop  for Open MP parallelisation
!$omp end do
      DEALLOCATE (work1)
!$omp end parallel
